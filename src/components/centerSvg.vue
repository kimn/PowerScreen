<template>
  <div class="center-svg">
    ...
    >
      <defs>
        ...
        >
          ...
          <feComposite in2="" result="composite" />
          <feComposite in2="" result="composite-2" />
          <feComposite in2="" result="composite-3" />
          <feFlood result="flood" flood-color="#1783ff" flood-opacity="0.9" />
          <feComposite result="composite-4" operator="in" in2="composite-3" />
          <feBlend result="blend" in2="SourceGraphic" />
          <feBlend in2="" result="blend-2" in="SourceGraphic" />
        </filter>
        <filter
          id="filter-2"
          x="258"
    ...
    <img class="lingxA" src="../assets/images/ling/lingxA.png" alt="" />
    <img class="lingxB" src="../assets/images/ling/lingxB.png" alt="" />
    <img class="lingxC" src="../assets/images/ling/lingxC.png" alt="" />
    <img class="lingxD" src="../assets/images/ling/lingxD.png" alt="" />
    <img class="lingxE" src="../assets/images/ling/lingxE.png" alt="" />
    <img class="lingxF" src="../assets/images/ling/lingxF.png" alt="" />
  </div>
</template>
